...
public class BaseUtils {
    ...
    public static String readPropsTestData(String fileName, String key){   // to read test data from object repository
        try {
            FileInputStream F = new FileInputStream("TestData/"+fileName+".properties");
    ...
    public void switchToFrame(String locator, String path){
        fluentWaitMethod();
        WebElement element;
        switch (locator) {
            case ("xpath"):
    ...
    public void scrollToElement(String locator, String path) {
        fluentWaitMethod();
        WebElement element;
        switch (locator) {
            case ("xpath"):
    ...
    public void scrollDownWholePage(){
        for(int i =0;i<=15;i++){
